...
describe SessionsController do
  ...
  describe "logout_killing_session!" do
    ...
    it 'kills :user_id session' do
      session.stubs(:[]=)
      session.expects(:[]=).with(:user_id, nil).at_least(1)
  ...
  describe "logout_keeping_session!" do
    ...
    it 'does not reset the session' do expects(:reset_session).times(0);   logout_keeping_session! end
