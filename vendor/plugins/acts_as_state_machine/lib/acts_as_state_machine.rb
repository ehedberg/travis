    ...
    module StateMachine              #:nodoc:
      ...
      module ActMacro
        ...
        def acts_as_state_machine(opts)
          ...
          class_eval "def initialize(args={});super;set_initial_state;end"
      ...
      module InstanceMethods
        ...
        def available_events
          ev = []  
          self.class.read_inheritable_attribute(:transition_table).each do |event_name, events|
            events.each do |e|
              ev << event_name if e.from.to_sym == current_state
            end
          end
          ev
        end
